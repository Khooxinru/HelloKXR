...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Variable declaration; 1) val = value(any memory x change any value); 2) var = variable (assign the value , change the value depend on user input)
